...
void hashset_init(struct hashset *s, hash_fn hash, equals_fn equals, size_t elt_size);
...
static bool hashset_empty(const struct hashset *s);
static ssize_t hashset_max_size(const struct hashset *s);
static size_t hashset_elt_size(const struct hashset *s);
