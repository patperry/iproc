...
void array_fill_range(struct array *a, ssize_t i, ssize_t n, const void *src);
...
#endif
static inline void *array_get(const struct array *a, ssize_t i, void *dst);
...
static inline void *array_ptr(const struct array *a, ssize_t i);
