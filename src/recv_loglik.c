...
static void recv_sloglik_init(struct recv_sloglik *ll, const struct model *model,
			      ssize_t isend);
...
static void recv_sloglik_axpy_avg_mean(double alpha, const struct recv_sloglik *sll,
				       struct vector *y);
static void recv_sloglik_axpy_avg_score(double alpha, const struct recv_sloglik *sll,
					struct vector *y);
static void recv_sloglik_axpy_avg_imat(double alpha, const struct recv_sloglik *sll,
				       struct matrix *y);
...
static void recv_sloglik_axpy_last_mean(double alpha, const struct recv_sloglik *sll,
					struct vector *y);
static void recv_sloglik_axpy_last_score(double alpha, const struct recv_sloglik *sll,
					 struct vector *y);
static void recv_sloglik_axpy_last_imat(double alpha, const struct recv_sloglik *sll,
					struct matrix *y);
